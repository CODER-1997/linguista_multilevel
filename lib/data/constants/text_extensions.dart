...
extension TextStringExtensions on String {
  ...
  //       '+${clearedPhone.substring(0, 3)} ${clearedPhone.substring(
  //       3, 5)} ${clearedPhone.substring(5, 8)} ${clearedPhone.substring(
  //       8, 10)} ${clearedPhone.substring(10)}';
  //   Logger().w(
  ...
  String toDateFormat() {
    return intl.DateFormat("yyyy-MM-dd").format(DateTime.parse(this));
  }

  // getDisplayName() {
  //   switch (this) {
  //     case "worker":
  //       return User.worker.nameUI;
  //     case "employer":
  //       return User.employer.nameUI;
  //   }
  // }
  //
  // toUser() {
  ...
  //   switch (this) {
  //     case "one_time":
  //       return Strings.oneTime;
  //     case "part_time":
  //       return Strings.partTim;
  //     case "full_time":
